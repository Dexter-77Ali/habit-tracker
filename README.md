...
|---------|------|------------|
| v0.5.0 | 2026-07-22 | ⏱ Time tracking: start/stop timer on habits & tasks (live ticker, per-day totals, synced) · 🔔 per-habit smart reminders (up to 4 times) + evening nudge · 📱 Android home-screen widget with one-tap check-off |
